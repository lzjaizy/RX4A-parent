...
public class User {
    ...
    public Integer getBindAddressType() {
        return bindAddressType;
    }

    public void setBindAddressType(Integer bindAddressType) {
        this.bindAddressType = bindAddressType;
    }
    ...
    public String getBindMacAddress() {
        return bindMacAddress;
    }

    public void setBindMacAddress(String bindMacAddress) {
        this.bindMacAddress = bindMacAddress;
    }
    ...
    public String toString() {
        return "user{" +
                ...
                ", flag9='" + flag9 + '\'' +
                ", flag10='" + flag10 + '\'' +
                ", bindAddressType=" + bindAddressType +
                ", bindIpAddress='" + bindIpAddress + '\'' +
                ", bindMacAddress='" + bindMacAddress + '\'' +
                '}';
    }
}
